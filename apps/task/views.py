...
from apps.task.success_messages import (
    TASK_UPDATED_SUCCESSFULLY_MESSAGE,
    TASK_WAS_DELETED_SUCCESSFUL,
...
class TaskDetailGenericView(RetrieveUpdateDestroyAPIView):
    ...
    def put(self, request: Request, *args, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            return Response(
                status=status.HTTP_200_OK,
                data={
                    "message": TASK_UPDATED_SUCCESSFULLY_MESSAGE,
                    "data": serializer.data
                }
            )
        else:
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return Response(
            status=status.HTTP_200_OK,
            data=TASK_WAS_DELETED_SUCCESSFUL
        )
